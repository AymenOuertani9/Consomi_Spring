...
public Event(int idEvent, String title, Date date, Date hour, String address, String description, String image,
		int views, int numberOfPlaces, boolean status, CategoryEvent categoryEvent,float priceTicket, List<Donation> donations,
...
public Event(String title, Date date, Date hour, String address, String description, String image, int views,
		int numberOfPlaces, boolean status, CategoryEvent categoryEvent,float priceTicket, List<Donation> donations,
		List<Advertisement> advertisements, Jackpot jackpot, List<Participation> participations) {
	super();
	this.title = title;
	this.date = date;
...
public String toString() {
	return "Event [idEvent=" + idEvent + ", title=" + title + ", date=" + date + ", hour=" + hour + ", address="
			...
			+ numberOfPlaces + ", status=" + status + ", priceTicket=" + priceTicket + ", categoryEvent="
			+ categoryEvent + ", donations=" + donations + ", advertisements=" + advertisements + ", jackpot=" + jackpot
